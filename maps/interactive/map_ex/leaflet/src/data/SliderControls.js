L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {balrg
        ...
        $(sliderContainer).append(
            '<divid="leaflet-slider" style="width:200px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px; margin-top:13px; background-color:#ff0000; text-align:center; border-radius:5px;"></div></div>');
