L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {balrg
        this.options.map = map;

        // Create a control sliderContainer with a jquery ui slider
        var sliderContainer = L.DomUtil.create('div', 'slider', this._container);
        $(sliderContainer).append('<div id="leaflet-slider" style="width:600px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:1200px; margin-top:100px; background-color:#ff0000; text-align:center; border-radius:5px;"></div></div>');
